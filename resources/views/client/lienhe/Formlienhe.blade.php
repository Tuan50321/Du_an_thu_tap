...
@section('title', 'Liên hệ - HOUSE HOLD GOOD')
    ...
    <div class="contact-wrapper">
        ...
        <div class="contact-form">
            ...
            <form action="{{ route('client.lienhe.store') }}" method="POST">
                ...
                <input type="text" name="subject" placeholder="Tiêu đề" value="{{ old('subject') }}" required>
                <textarea name="message" rows="5" placeholder="Nội dung" required>{{ old('message') }}</textarea>
