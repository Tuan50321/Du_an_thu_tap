    ...
    <nav class="navbar navbar-expand-lg" style="background-color: #012035;">
        <div class="container">
            <a class="navbar-brand d-flex align-items-center" href="{{ route('home') }}">
                <img src="{{ asset('storage/logo/logo.png') }}" alt="Logo" style="height:80px; width:auto; margin-right:18px;">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <form class="d-flex me-3" action="{{ route('search') }}" method="GET" style="max-width: 300px;">
                    <input class="form-control me-2" type="search" name="q" value="{{ isset($query) ? $query : '' }}" placeholder="Tìm kiếm sản phẩm..." aria-label="Tìm kiếm">
