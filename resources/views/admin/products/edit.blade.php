                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    @if($product->thumbnail)
                                        <div class="mt-2">
                                            <img src="{{ $product->thumbnail_url }}" alt="Thumbnail" class="img-thumbnail" style="max-width: 200px;">
                                        </div>
                                    @endif
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="stock" name="stock" required min="0" value="{{ old('stock', $product->stock) }}">
                                </div>
                            </div>
                        </div>
