    ...
    <nav class="navbar navbar-expand-lg" style="background-color: #012035;">
        <div class="container">
            <a class="navbar-brand d-flex align-items-center" href="<?php echo e(route('home')); ?>">
                <img src="<?php echo e(asset('storage/logo/logo.png')); ?>" alt="Logo" style="height:80px; width:auto; margin-right:18px;">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    <li class="nav-item">
                        <a class="nav-link text-white" href="<?php echo e(route('home')); ?>">Trang chủ</a>
                    </li>
                ...
                <form class="d-flex me-3" action="<?php echo e(route('search')); ?>" method="GET" style="max-width: 300px;">
                    <input class="form-control me-2" type="search" name="q" value="<?php echo e(isset($query) ? $query : ''); ?>" placeholder="Tìm kiếm sản phẩm..." aria-label="Tìm kiếm">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4 mb-4">
                    <h5>Về chúng tôi</h5>
                    <p>Householdgood - Nơi mua sắm trực tuyến uy tín, chất lượng với đa dạng sản phẩm và dịch vụ tốt nhất.</p>
            ...
            <div class="row">
                ...
                <div class="col-md-6 text-end">
                    <img src="https://via.placeholder.com/200x30/007bff/ffffff?text=Payment+Methods" alt="Payment Methods" class="img-fluid">
                </div>
            </div>
        </div>
    </footer>
...
</html> <?php /**PATH C:\laragon\www\Du_an_thu_tap\resources\views/client/layouts/app.blade.php ENDPATH**/ ?>