        ...
        <div class="col-md-6 col-lg-4">
            <div class="card product-card h-100">
                ...
                <?php if($product->discount_price > 0 && $product->discount_price < $product->price): ?>
                    <div class="sale-badge">-<?php echo e(round((($product->price - $product->discount_price) / $product->price) * 100)); ?>%</div>
                <?php endif; ?>
                <a href="<?php echo e(route('client.product.details', ['id' => $product->product_id])); ?>">
                    <img src="<?php echo e($product->thumbnail_url); ?>" class="card-img-top product-image" alt="<?php echo e($product->name); ?>">
                </a>
                <div class="card-body d-flex flex-column">
                    ...
                    <div class="mt-auto">
                        <div class="d-flex justify-content-between align-items-center mb-2">
                             <?php if($product->discount_price > 0 && $product->discount_price < $product->price): ?>
                                <span class="text-danger fw-bold"><?php echo e(number_format($product->discount_price)); ?> VNĐ</span>
                                <span class="text-muted text-decoration-line-through small"><?php echo e(number_format($product->price)); ?> VNĐ</span>
                             <?php else: ?>
                                <span class="fw-bold"><?php echo e(number_format($product->price)); ?> VNĐ</span>
                             <?php endif; ?>
                        </div>
    ...
    <div class="row">
        ...
        <aside class="col-lg-3">
            <div class="filter-sidebar">
                ...
                <div class="mb-4">
                    ...
                    <ul class="list-group filter-group" id="filter-category">
                        ...
                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li class="list-group-item" data-id="<?php echo e($category->category_id); ?>">
                                <?php echo e($category->name); ?>

                                <span class="badge bg-light text-dark rounded-pill float-end"><?php echo e($category->products_count); ?></span>
                            </li>
                ...
                <div class="mb-4">
                    ...
                    <ul class="list-group filter-group" id="filter-brand">
                        ...
                        <?php $__currentLoopData = $brands; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $brand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li class="list-group-item" data-id="<?php echo e($brand->brand_id); ?>">
                                <?php echo e($brand->name); ?>

                                <span class="badge bg-light text-dark rounded-pill float-end"><?php echo e($brand->products_count); ?></span>
                            </li>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </ul>
                </div>
                ...
                <div class="d-grid">
                    <a href="<?php echo e(route('client.products.index')); ?>" class="btn btn-outline-secondary">Xóa tất cả bộ lọc</a>
                </div>
            </div>
        </aside>
        ...
        <main class="col-lg-9">
            ...
            <header class="d-flex justify-content-between align-items-center mb-4">
                <p class="mb-0 text-muted">Hiển thị <?php echo e($products->firstItem()); ?>-<?php echo e($products->lastItem()); ?> của <?php echo e($products->total()); ?> sản phẩm</p>
            ...
            <div id="product-list-container">
                <?php echo $__env->make('client.products.partials.product_list', ['products' => $products], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            </div>
        </main>
    </div>
</div>
...
$(document).ready(function() {
    ...
    function fetchProducts() {
        ...
        // Build URL
        let url = new URL('<?php echo e(route("client.products.index")); ?>');
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('client.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Du_an_thu_tap\resources\views/client/products/partials/product_list.blade.php ENDPATH**/ ?>