                ...
                <div class="mb-3">
                    ...
                    <div class="form-check mb-2">
                        <input class="form-check-input" type="radio" name="payment_method" id="payment_momo"
                            value="momo" <?php echo e(old('payment_method') == 'momo' ? 'checked' : ''); ?>>
...
<?php echo $__env->make('client.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Du_an_thu_tap\resources\views/client/orders/checkout.blade.php ENDPATH**/ ?>