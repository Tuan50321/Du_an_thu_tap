    ...
    <section class="hero-section">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <h1 class="display-4 fw-bold mb-4">Chào mừng đến với <span style="color:#ff9900">HOUSE HOLD GOOD</span></h1>
                    <p class="lead mb-4">Chuyên cung cấp các sản phẩm <b>đồ gia dụng</b> chất lượng cao, an toàn và tiện ích cho mọi gia đình Việt. Khám phá hàng ngàn sản phẩm từ nồi chảo, bếp điện, máy lọc nước, thiết bị nhà bếp, đồ dùng phòng tắm, vệ sinh, chăm sóc nhà cửa... với giá tốt nhất!</p>
                ...
                <div class="col-lg-6">
                    ...
                    <?php else: ?>
                        <img src="https://via.placeholder.com/600x400?text=No+Banner" alt="No Banner" class="img-fluid rounded shadow">
                    <?php endif; ?>
                </div>
            </div>
        </div>
                ...
                <?php $__currentLoopData = $brands->take(6); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $brand): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-md-2 col-6 text-center">
                        <div class="brand-card">
                            <?php if($brand->logo): ?>
                                <img src="<?php echo e(asset('storage/' . $brand->logo)); ?>" alt="<?php echo e($brand->name); ?>" class="img-fluid mb-2" style="max-height: 60px; filter: drop-shadow(0 2px 8px #6366f1aa);">
                            <?php else: ?>
                                <i class="fas fa-industry fa-3x mb-2"></i>
                            <?php endif; ?>
                            <div><h6 class="mb-0"><?php echo e($brand->name); ?></h6></div>
                        </div>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
                ...
                <?php $__currentLoopData = $latestNews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $news): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-md-4">
                        <div class="card news-card h-100">
                            <img src="<?php echo e($news->image ? asset('storage/' . $news->image) : 'https://via.placeholder.com/400x250/cccccc/666666?text=News'); ?>" 
                                 class="card-img-top" alt="<?php echo e($news->title); ?>" style="height: 200px; object-fit: cover;">
                            <div class="card-body">
                                <h6 class="card-title"><?php echo e($news->title); ?></h6>
                                <p class="card-text text-muted"><?php echo e(Str::limit($news->summary ?? $news->content, 120)); ?></p>
                                <div class="d-flex justify-content-between align-items-center">
                                    <small class="text-muted"><?php echo e($news->created_at ? $news->created_at->format('d/m/Y') : 'N/A'); ?></small>
