                    ...
                    <tbody>
                        <?php $__currentLoopData = $banners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $banner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td><?php echo e($banner->banner_id); ?></td>
                                 <td>
                                    <?php if($banner->image_url): ?>
                                        <img src="<?php echo e(asset('storage/' . $banner->image_url)); ?>" alt="Banner" class="img-fluid" style="max-width: 150px;">
                                    <?php else: ?>
                                        No Image
                                    <?php endif; ?>
                                </td>
                                ...
                                <td>
                                    <a href="<?php echo e(route('admin.banners.show', $banner)); ?>" class="btn btn-sm btn-info" title="View Details">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                    <a href="<?php echo e(route('admin.banners.edit', $banner)); ?>" class="btn btn-sm btn-warning" title="Edit">
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\Du_an_thu_tap\resources\views/admin/banners/index.blade.php ENDPATH**/ ?>