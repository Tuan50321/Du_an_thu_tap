                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="tel" class="form-control" id="phone" name="phone"
                                            value="<?php echo e(Auth::user()->profile->phone ?? ''); ?>" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="birthday">Ngày sinh</label>
                                        <input type="date" class="form-control" id="birthday" name="birthday"
                                            value="<?php echo e(optional(optional(Auth::user()->profile)->birthday)->format('Y-m-d')); ?>">
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="gender" name="gender">
                                            ...
                                            <option value="1"
                                                <?php echo e(optional(Auth::user()->profile)->gender == 1 ? 'selected' : ''); ?>>Nam
                                            </option>
                                            <option value="0"
                                                <?php echo e(optional(Auth::user()->profile)->gender == 0 ? 'selected' : ''); ?>>Nữ
                                            </option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="province" name="province"
                                            value="<?php echo e(Auth::user()->profile->province ?? ''); ?>">
                                    </div>
                                    <div class="form-group">
                                        <label for="district">Quận/Huyện</label>
                                        <input type="text" class="form-control" id="district" name="district"
                                            value="<?php echo e(Auth::user()->profile->district ?? ''); ?>">
                                    </div>
                                    <div class="form-group">
                                        <label for="ward">Phường/Xã</label>
                                        <input type="text" class="form-control" id="ward" name="ward"
                                            value="<?php echo e(Auth::user()->profile->ward ?? ''); ?>">
                                    </div>
                                    <div class="form-group">
                                        <label for="street">Đường</label>
                                        <input type="text" class="form-control" id="street" name="street"
                                            value="<?php echo e(Auth::user()->profile->street ?? ''); ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="mt-4">
