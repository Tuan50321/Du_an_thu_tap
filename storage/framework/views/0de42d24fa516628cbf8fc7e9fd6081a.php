                        ...
                        <div class="mt-5">
                            ...
                            <?php else: ?>
                                <div class="alert alert-warning">
                                    Vui lòng <a href="<?php echo e(route('login')); ?>" class="text-primary fw-bold">đăng nhập</a> để gửi
                                    bình luận.
                                </div>
                            <?php endif; ?>
                        </div>
...
<?php echo $__env->make('client.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\Du_an_thu_tap\Du_an_thu_tap\resources\views/client/news/show.blade.php ENDPATH**/ ?>